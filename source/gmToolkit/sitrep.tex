...
% not bold in original text, maybe should be
Key terms:
...
% pretty ugly table, will make some nicer ones later
...
% removing some of these for better flow, should probably make a proper layout box for these but whatever can do that later
%\newpage
\subsection{Control}
...
\end{wrapfigure}
% not sure this should have the , on the end, but preserved for the mo
