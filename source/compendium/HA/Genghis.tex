...
\frameBox[hp = 8,
    ...
    tech attack = -2,
    traits ={
        \textbf{Insulated:} The GENGHIS is immune to Burn
...
\gearBox[name = {Explosive Vent},
    ...
    template = {2 SP, \Unique, \textbf{System}}, %TODO: this used to be \System
    rules = {When you cool heat, you explosively vent heat in a \Burst{1} area around you. Affected targets, friend or foe, take \HeatTarget{1d3} and \Burn.}
]

\gearBox[name = {Auto-Cooler},
...
template = {2 SP\\
\Mine, \Limited{2}}
rules = {When detonated, this mine attacks a \line{5} zone from the mine instead of a burst area around the mine (oriented in any direction). Affected targets must pass an agility check or take \Burn{6} or \Burn{3} on a successful check.}
]

\gearRules[name = {Plasma Thrower}
