...
•  \hypertarget{Damage Type}{Damage type}: All weapons deal Explosive, Kinetic, or Energy damage


•  \hypertarget{Heat Target}{Heat (Target)}: this tag indicates a weapon or system that deals additional Heat on hit to its
  target.
...
•  \hypertarget{Arcing}{Arcing} - This weapon ignores line of sight as long as it can trace a path to its target, but still
...
•  \hypertarget{Heat Self}{Heat X (self)} - This weapon inflicts X heat on its wielder immediately after firing
...
•  \hypertarget{Threat}{Threat X} - A weapon can be used to make overwatch attacks at range X. A melee weapon’s
  range is its threat.
...
•  \hypertarget{Deployable}{Deployable} - This system can be deployed in a free adjacent space as a quick action, unless
  otherwise noted. It has 10 hp/size and evasion 5.

•  \hypertarget{Drone}{Drone} - Indicates a self-propelled system with rudimentary intelligence. Some drone systems
...
•  \hypertarget{Mod}{Mod} - Indicates a weapon mod. Only one can be taken per weapon.
