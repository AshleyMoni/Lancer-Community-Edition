...
\usepackage{pgfkeys}
\usepackage{xcolor,colortbl,tabularx,chngpage}
...
\newcommand\frameTable[1][] {
\pgfkeys{/frame, default, #1}
\begin{table}


    \begin{center}
      \begin{tabularx}{140mm}{| c | c | c | c | c |}
        \hline
        \rowcolor{Gray}
        \multicolumn{5}{|c|}{\textbf{\frameName}} \\[5mm] \hline
        ...
        \multicolumn{5}{|p{135mm}|}{\frameTraits} \\ \hline
        \rowcolor{Gray}
        \multicolumn{5}{|c|}{\textbf{SYSTEM POINTS:} \frameSP} \\[5mm] \hline
        \rowcolor{Gray}
        \multicolumn{5}{|c|}{\textbf{MOUNTS:}} \\[5mm] \hline
        \multicolumn{2}{|p{30mm}|}{\frameMountOne} & \multicolumn{2}{|p{30mm}|}{\frameMountTwo} & \multicolumn{1}{|l|}{\frameMountThree} \\ \hline
        \rowcolor{Gray}
        \multicolumn{5}{|c|}{\textbf{CORE system}} \\[5mm] \hline
        \multicolumn{5}{|c|}{\textbf{\frameCoreSystemName}} \\
        \multicolumn{5}{|p{135mm}|}{\frameCoreSystemText} \\
        \multicolumn{5}{|p{135mm}|}{\textbf{\frameCoreActiveName}} \\
        \multicolumn{5}{|p{135mm}|}{\frameCoreActiveText} \\ \hline
      \end{tabularx}
    \end{center}
